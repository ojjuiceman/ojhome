...
var filePath = gitmojiPath ? path_1.join(process.cwd(), gitmojiPath) : // or use gitmoji file
...
if (!fs_1.existsSync(filePath)) {
  ...
  try {
    ...
    throw Error('Failed to fetch gitmoji JSON, please refer to https://github.com/arvinxx/gitmoji-commit-workflow/tree/master/packages/commitlint-plugin#fetch-error for help.');
  }
