        ...
        <Link href="https://okerajohnson.com" passHref>
          ...
          >
            <div className="flex h-full w-full flex-col items-center justify-center rounded-lg bg-primary px-2 text-center font-medium">
              <p className="text-xl font-semibold">Next Js Blog</p>
              <p>My blog about developing and online business</p>
            </div>
          </a>
        </Link>

        <Link href="https://github.com/ojjuiceman/jay4" passHref>
          <a
          ...
          >
            <div className="flex h-full w-full flex-col items-center justify-center rounded-lg bg-primary px-2 text-center font-medium">
              <p className="text-xl font-semibold">Password Generator</p>
              <p>Website that generates passwords and then Emails the password to the user.</p>
            </div>
          </a>
        </Link>
      </div>
